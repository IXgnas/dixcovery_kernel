...
static int __init cpufreq_interextrem_init(void)
{
	...
	pm_qos_add_notifier(PM_QOS_CLUSTER1_FREQ_MIN, &cpufreq_interextrem_cpu_min_qos_notifier);
	pm_qos_add_notifier(PM_QOS_CLUSTER1_FREQ_MAX, &cpufreq_interextrem_cpu_max_qos_notifier);
#endif
#endif
