...
echo "1248000" > /sys/devices/system/cpu/cpu1/cpufreq/scaling_max_freq
echo  "624000" > /sys/devices/system/cpu/cpu1/cpufreq/scaling_min_freq
echo "1248000" > /sys/devices/system/cpu/cpu2/cpufreq/scaling_max_freq
echo  "624000" > /sys/devices/system/cpu/cpu2/cpufreq/scaling_min_freq
echo "1248000" > /sys/devices/system/cpu/cpu3/cpufreq/scaling_max_freq
echo  "624000" > /sys/devices/system/cpu/cpu3/cpufreq/scaling_min_freq
...
echo  "624000" > /sys/devices/system/cpu/cpu5/cpufreq/scaling_min_freq
echo "1248000" > /sys/devices/system/cpu/cpu6/cpufreq/scaling_max_freq
echo  "624000" > /sys/devices/system/cpu/cpu6/cpufreq/scaling_min_freq
echo "1248000" > /sys/devices/system/cpu/cpu7/cpufreq/scaling_max_freq
echo  "624000" > /sys/devices/system/cpu/cpu7/cpufreq/scaling_min_freq
